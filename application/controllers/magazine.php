...
class Magazine extends CI_Controller {
	 ...
	 * http://dev.childroad.com/main.php/magazine/get_token?books=22,36&random=as23sf2q432&timestamp=17002120&sign=0da26aaa558a1478f49516b18d36b5df
	 */
	...
	/**
	 * @deprecated 获取书本资源
	 * http://dev.childroad.com/main.php/magazine/get_res/22/b291b81a5dce382/100ChengYuGuShi01_p1/p1_swf.swf
	 */
	public function get_res($bookid = 0, $token = 0, $path = 0, $filename = 0) {
		...
		//检查文件是否存在
		if(!file_exists($this->config->item('magazine_file').$books['content'].'/'.$filepath)) {
			output(array('success'=>'No', 'data'=>'File not exist'));
		}

		$filedata = read_file($this->config->item('magazine_file').$books['content'].'/'.$filepath);
